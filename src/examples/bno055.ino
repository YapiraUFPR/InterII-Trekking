...
*
https://learn.adafruit.com/adafruit-bno055-absolute-orientation-sensor/arduino-code#adafruit-unified-sensor-system-
4-10
...
{
    Serial.begin(9600);
    Serial.println("Position Calculator Calibrating... Move your leg to calibrate...");
    Serial.println("");
