...
{
    pub_latest_odometry = n->create_publisher<nav_msgs::msg::Odometry>("/vins_fusion/imu_propagate", 1000);
    pub_path = n->create_publisher<nav_msgs::msg::Path>("/vins_fusion/path", 1000);
    pub_odometry = n->create_publisher<nav_msgs::msg::Odometry>("/vins_fusion/odometry", 1000);
    pub_point_cloud = n->create_publisher<sensor_msgs::msg::PointCloud>("/vins_fusion/point_cloud", 1000);
    pub_margin_cloud = n->create_publisher<sensor_msgs::msg::PointCloud>("/vins_fusion/margin_cloud", 1000);
    pub_key_poses = n->create_publisher<visualization_msgs::msg::Marker>("/vins_fusion/key_poses", 1000);
    pub_camera_pose = n->create_publisher<nav_msgs::msg::Odometry>("/vins_fusion/camera_pose", 1000);
    pub_camera_pose_visual = n->create_publisher<visualization_msgs::msg::MarkerArray>("/vins_fusion/camera_pose_visual", 1000);
    pub_keyframe_pose = n->create_publisher<nav_msgs::msg::Odometry>("/vins_fusion/keyframe_pose", 1000);
    pub_keyframe_point = n->create_publisher<sensor_msgs::msg::PointCloud>("/vins_fusion/keyframe_point", 1000);
    pub_extrinsic = n->create_publisher<nav_msgs::msg::Odometry>("/vins_fusion/extrinsic", 1000);
    pub_image_track = n->create_publisher<sensor_msgs::msg::Image>("/vins_fusion/image_track", 1000);
